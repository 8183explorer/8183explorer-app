...
'tokenomics': () => (
  <div>
    <p style={p}><strong>$TRUST</strong> is the native utility token of the 8183Explorer platform. It is launched via the <strong>Virtuals Protocol</strong> and governs access to premium features including full audit reports, unlimited searches, and future API access.</p>
